...
if __name__ == "__main__":
    ...
    server = INSnipServer(args, config, resnet18(num_classes=100))
    ...
    client_list = [INSnipClient(config, list_models[idx]) for idx in range(NUM_CLIENTS)]
