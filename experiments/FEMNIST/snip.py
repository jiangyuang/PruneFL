...
class FEMNISTSnipServer(SnipServer):
...
class FEMNISTSnipClient(SnipClient):
...
if __name__ == "__main__":
    ...
    server = FEMNISTSnipServer(args, config, Conv2())
    ...
    client_list = [FEMNISTSnipClient(config, list_models[idx]) for idx in range(NUM_CLIENTS)]
