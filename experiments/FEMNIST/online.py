...
class FEMNISTOnlineServer(OnlineServer):
...
class FEMNISTOnlineClient(OnlineClient):
...
if __name__ == "__main__":
    ...
    server = FEMNISTOnlineServer(args, config, Conv2())
    ...
    client_list = [FEMNISTOnlineClient(config, list_models[idx]) for idx in range(NUM_CLIENTS)]
