...
class CelebAItPrServer(ItPrServer):
...
class CelebAItPrClient(ItPrClient):
...
if __name__ == "__main__":
    ...
    server = CelebAItPrServer(args, config, Conv4())
    ...
    client_list = [CelebAItPrClient(config, list_models[idx]) for idx in range(NUM_CLIENTS)]
