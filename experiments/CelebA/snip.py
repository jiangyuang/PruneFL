...
class CelebASnipServer(SnipServer):
...
class CelebASnipClient(SnipClient):
...
if __name__ == "__main__":
    ...
    server = CelebASnipServer(args, config, Conv4())
    ...
    client_list = [CelebASnipClient(config, list_models[idx]) for idx in range(NUM_CLIENTS)]
