...
class CelebAReinitServer(ReinitServer):
...
class CelebAReinitClient(ReinitClient):
...
if __name__ == "__main__":
    ...
    server = CelebAReinitServer(args, config, Conv4())
    ...
    client_list = [CelebAReinitClient(config, list_models[idx]) for idx in range(NUM_CLIENTS)]
