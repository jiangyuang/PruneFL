...
class CIFAR10OnlineServer(OnlineServer):
...
class CIFAR10OnlineClient(OnlineClient):
...
if __name__ == "__main__":
    ...
    server = CIFAR10OnlineServer(args, config, VGG11())
    ...
    client_list = [CIFAR10OnlineClient(config, list_models[idx]) for idx in range(NUM_CLIENTS)]
